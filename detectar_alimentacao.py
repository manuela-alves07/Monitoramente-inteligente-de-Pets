...
while cap.isOpened():
    ...
    # Detectar cão e tigela no frame
    ...
    #Lógica de se esta comendo ou não alimentação
...
if ultima_refeicao:
    ...
    if sem_comer > 6 * 3600:
        relatorio["alertas"].append({
            ...
            "mensagem": f"Animal sem comer ha {sem_comer/3600:.1f}h",
            "nivel": "critico"
        })
if len(eventos) == 0:
    relatorio["alertas"].append({
